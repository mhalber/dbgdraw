...
init(app_state_t* state)
{
  ...
  d3d11_ctx_desc_t d3d11_desc = {.win_title    = "dbgdraw_d3d11_basic",
                                 .win_x        = 100,
                                 .win_y        = 100,
                                 .win_w        = 640,
                                 .win_h        = 320,
  ...
  dd_ctx_desc_t desc = {.max_vertices        = 32,
                        .max_commands        = 16,
                        .detail_level        = 2,
...
frame(app_state_t* state)
{
  ...
  msh_vec3_t x0 = msh_vec3_negx();
  msh_vec3_t x1 = msh_vec3_posx();
  msh_vec3_t y0 = msh_vec3_negy();
  msh_vec3_t y1 = msh_vec3_posy();
  msh_vec3_t z0 = msh_vec3_negz();
  msh_vec3_t z1 = msh_vec3_posz();
